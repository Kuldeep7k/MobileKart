...
<head>
  ...
  <title>Online Best Shopping Site for Mobiles</title>
  <!-- MDB icon -->
...
<body>
  ...
  <main class="mt-1">
    <div class="container">
      ...
      <nav class="navbar navbar-light mb-3" style="background-color: #0000;">
        <div class="container-fluid justify-content-center">
          <img src="./img/Banners/jstld.png" class="img-fluid w-100 border-bottom" alt="..." />
        </div>
      </nav>
      <!-- banner Navbar content -->
      <!------Product section --->
      <section class="text-center">
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-12 mb-4" style="width: 285px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/xiaomi-mi11-ultra-5g.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=1">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=1">
                  <h5 class="card-title">Xiaomi Mi 11 Ultra 5G</h5>
                </a>
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/iphone 12 pro max.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=4">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/mi 10i.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=3">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=3">
                  <h5 class="card-title">Xiaomi Mi 10i</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 23,999.00</h4>
              </div>
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/Mi 11X.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=2">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=2">
                  <h5 class="card-title">Xiaomi Mi 11x Pro</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 41,999.00</h4>
              </div>
        ...
        <!---banner---->
        <img src="./img/Banners/offers.png" class="img-fluid w-100 border-bottom mb-4" alt="..." />
        <!---banner---->
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/SM A52.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=9">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=9">
                  <h5 class="card-title">Samsung Galaxy A52 5G</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 24,999.00</h4>
              </div>
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/M42 5g.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=10">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/SM S21 ultra 5g.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=7">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/fold 2.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=8">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=8">
                  <h5 class="card-title">Samsung Galaxy Z Fold 2 5G</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 1,49,999.00</h4>
              </div>
        ...
        <!---banner---->
        <img src="./img/Banners/mobiles.png" class="img-fluid w-100 border-bottom mb-4" alt="..." />
        <!---banner---->
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/iphone 12 pro.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=5">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/iphone 12.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=6">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/oneplus 9pro-5G.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=11">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/oneplus 9R.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=12">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=12">
                  <h5 class="card-title">OnePlus 9R 5G</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 43,999.00</h4>
              </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/oneplus 9.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=13">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=13">
                  <h5 class="card-title">OnePlus 9 5G</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 54,860.00</h4>
              </div>
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/note 10.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=14">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=14">
                  <h5 class="card-title">Xiaomi Redmi Note 10</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 12,499.00</h4>
              </div>
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/note10 pro.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=16">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-4 col-md-12 mb-4" style="width: 275px;">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/Models/note10 pro max.jpg" class="card-img-top w-100" />
                <a href="Products.php?Deviceid=15">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card-body">
                <a href="Products.php?Deviceid=15">
                  <h5 class="card-title">Xiaomi Redmi Note 10 Pro Max</h5>
                </a>
                <h6 class="card-subtitle mb-2 text-muted">Available</h6>
                <h4>₹ 19,999.00</h4>
              </div>
    ...
    <nav aria-label="...">
      <ul class="pagination pagination-circle justify-content-center mb-3">
        <li class="page-item">
          <a class="page-link" href="#" tabindex="-1" aria-disabled="true"> </a>
        </li>
        <li class="page-item active"><a class="page-link" href="index.php">1<span class="visually-hidden">(current)</span></a></li>
        <li class="page-item " aria-current="page">
          <a class="page-link" href="Page 2.php">2 </a>
        </li>
        <li class="page-item">
          <a class="page-link" href="Page 2.php">Next</a>
        </li>
      </ul>
    </nav>
    </section>
  ...
  <footer class="text-center text-lg-start bg-light text-muted">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <h6 class="text-uppercase fw-bold mb-4">
              <i class="navbar-brand ms-auto" href="index.php">
                <img src="./img/Mobilekart.jpg" height="57" alt="" loading="lazy" />
              </i>
            </h6>
            <p>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
      © 2021 Copyright:
      <a class="text-reset fw-bold" href="index.php">Mobilekart.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
